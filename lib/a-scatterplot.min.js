...
var createText = __webpack_require__(8)
var loadFont = __webpack_require__(7)
var colors = __webpack_require__(6)
var MSDFShader = __webpack_require__(9)
...
function setupHighlight(el, json, data, particleSystem) {
    ...
    function render() {
        ...
        var raycaster = document.querySelectorAll('a-entity[raycaster]');

        if (raycaster.length > 0 && raycaster[0] && raycaster[0].components && raycaster[0].components.raycaster && raycaster[0].components.raycaster.raycaster) {
            raycaster = raycaster[0].components.raycaster.raycaster;
        } else {
            return;
        }
    ...
    tick = function() {
        ...
        if (raycaster.length > 0 && raycaster[0] && raycaster[0].components
            && raycaster[0].components.raycaster && raycaster[0].components.raycaster.raycaster) {
            raycaster = raycaster[0].components.raycaster.raycaster;
        } else {
            return;
        }
        ...
        if (intersects.length > 0) {
            ...
            // Get the value
            var point = json[highlighted.index];

            // Output the coordinate
            var position = particleSystem.geometry.vertices[highlighted.index];
            result = {
                absPosition: Object.assign({}, highlighted.point),
                relPosition: Object.assign({}, position),
                value: {
                    x: point[data.x],
                    y: point[data.y],
                    z: point[data.z],
        ...
        particleSystem.geometry.colorsNeedUpdate = true;
        el.dispatchEvent(new CustomEvent("point-hover", { detail: result }));
    };
}
...
function renderGeometryAndKeyFromPath(el, data) {
    ...
    d3.json(data.src, function(json) {
        ...
        setupHighlight(el, json, data, particleSystem);
...
function renderGeometryFromRaw(el, data) {
    ...
    json.forEach(function(point){
        ...
        vertex.x = stats.scaleX(point[data.x]) - 0.5;
        vertex.y = stats.scaleY(point[data.y]) - 0.5;
        vertex.z = stats.scaleZ(point[data.z]) - 0.5;
        geometry.vertices.push(vertex)
...
/* WEBPACK VAR INJECTION */(function(Buffer) {var equal = __webpack_require__(14)
...
var dtype = __webpack_require__(2)
var anArray = __webpack_require__(11)
